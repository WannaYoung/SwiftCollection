...
open class RefreshComponent: UIControl {
    ...
    private var _refreshState: CurrentState = .idle
    open var refreshState: CurrentState {
        get {
    ...
    convenience public init(refreshHandler: @escaping RefreshHandler) {
        self.init()
    ...
    open func doOnAnyState(with oldState: CurrentState) {}
    
    open func doOnIdle(with oldState: CurrentState) {}
    
    open func doOnNoMoreData(with oldState: CurrentState) {}

    open func doOnPulling(with oldState: CurrentState) {}
    
    open func doOnWillRefresh(with oldState: CurrentState) {}
    
    open func doOnRefreshing(with oldState: CurrentState) {}

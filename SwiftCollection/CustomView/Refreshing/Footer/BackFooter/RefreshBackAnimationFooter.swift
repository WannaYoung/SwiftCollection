...
// MARK: - RefreshAnimationComponent
extension RefreshBackAnimationFooter: RefreshAnimationConvertor {
    public func setImages(_ images: [UIImage], for state: RefreshComponent.CurrentState) {
        
    }
    
    public func setImages(_ images: [UIImage], duration: TimeInterval, for state: RefreshComponent.CurrentState) {
